...
$lang = array_merge($lang, [
	...
	'BC_BEST_POS'				=> 'Meilleur classement',
	...
	'BC_EMBED_FORMAT_ERROR'		=> 'Le code à entrer doit commencer par <strong>&lt;object</strong> ou <strong>&lt;iframe</strong> et se terminer par <strong>&lt;/object&gt;</strong> ou <strong>&lt;/iframe&gt;</strong>',
	...
	'BC_NEEDED'					=> 'Les champs avec [*] sont obligatoires.Tous les autres sont optionnels.',
	...
	'BC_SONG_ARTIST_ADD'		=> '[*] Nom de l’artiste ou du groupe',
	...
	'BC_SONG_TITLE'				=> 'Titre',
	'BC_SONG_TITLE_ADD'			=> '[*] Titre',
	'BC_SONG_TITLE_EXPLAIN'		=> 'Entrez ici le titre de la chanson',
	'BC_SONG_VIDEO'				=> 'Clip video',
	'BC_SONG_VIDEO_EXPLAIN'		=> 'Entrer ici le code d’intégration correspondant, que vous aurez avec YouTube par exemple.<br /><strong>Attention : </strong>ne pas dépasser une largeur (width) de 730.<br /><br /><strong>Prenez garde de ne violer aucun copyright!</strong>',
	...
	'BC_VOTE_SUCCESS'			=> '<strong>Votre vote a été pris en compte.</strong><br /><br />Merci d’avoir voté pour cette chanson <strong>%1$s</strong> de <strong>%2$s</strong>.<br />Vous pourrez voter à nouveau pour cette chanson lors de la prochaine période…',
	'BC_VOTE_SUCCESS_UPS'		=> '<strong>Votre vote a été pris en compte.</strong><br /><br />Merci d’avoir voté pour cette chanson <strong>%1$s</strong> de <strong>%2$s</strong>.<br />Vous recevez <strong>%3$s  %4$s</strong> pour votre vote.<br /><br />Vous pourrez voter à nouveau pour cette chanson lors de la prochaine période…',
	'BC_VOTED_USERS'			=> [
