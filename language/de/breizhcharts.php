...
$lang = array_merge($lang, [
	...
	'BC_AJAX_NOTE_TOTAL'			=> 'Durchschnittsnote: <span>%s</span>',
	'BC_AJAX_NO_VOTE'				=> 'Sie dürfen die Bilder nicht bewerten…',
	'BC_AJAX_NOTE'					=> [
	...
	'BC_SONG_VIDEO_EXPLAIN'			=> 'Geben Sie hier die URL des YouTube-Videos ein.<br />Um es abzurufen, klicken Sie mit der rechten Maustaste in das gewünschte Video und:<br /><em>Kopiere die Video Adresse</em><br /><br /><strong>Bitte stelle auch sicher, daß Du nur auf Videos verlinkst, die keine Urheberrechte verletzen!</strong>',
	'BC_SONG_WEBSITE'				=> 'Webseite',
	'BC_SONG_WEBSITE_EXPLAIN'		=> 'Der Link zum Künstler, zur Künstlerin oder der Band (komplett mit https://)<br />(z.B: https://www.yourdomain.com)',
	'BC_SONG_YEAR'					=> 'Jahr',
