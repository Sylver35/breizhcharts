...
$lang = array_merge($lang, [
	...
	'BC_EMBED_FORMAT_ERROR'			=> 'The embedded code has to start with something like <strong>object</strong> or <strong>iframe</strong>!',
	...
	'BC_SONG_ARTIST_ADD'			=> '[*] Name of Artist or Band Name',
	...
	'BC_VOTE_SUCCESS'				=> '<strong>Your voting was successfully set!</strong><br /><br />Thanks a lot for your voting for the song <strong>%1$s</strong> from <strong>%2$s</strong>.<br />You can vote again for this song as soon as the current period ends and the voting table was reset.',
	'BC_VOTE_SUCCESS_UPS'			=> '<strong>Your voting was successfully set!</strong><br /><br />Thanks a lot for your voting for the song <strong>%1$s</strong> from <strong>%2$s</strong>.<br />You received <strong>%3$s %4$s</strong> for your voting!<br /><br />You can vote again for this song as soon as the current period ends and the voting table was reset.',
	'BC_VOTED_USERS'				=> [
